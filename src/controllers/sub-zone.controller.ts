...
import {subZoneInterFace,updateSubZoneInterFace} from '../interface/sub-zone.interface';
import {addZoneService,listZoneSetUpService,deleteZoneSetUpService,updateZoneSetUpService,updateZoneSetUpLocationsService} from '../services/sub-zone.service';
export default class ZoneSetupController{
    ...
    async AddZone(req:express.Request, res: express.Response){
        try {
              const payload:subZoneInterFace = req.body;
              let options:subZoneInterFace ={
    ...
    async UpdateZoneSetup(req:express.Request, res: express.Response){
        try {
            const payload:updateSubZoneInterFace = req.body;
