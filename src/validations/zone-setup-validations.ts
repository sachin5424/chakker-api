...
import {checkUniqueZoneNameValidation,findOneZone,checkByIdUniqueZoneNameValidation} from '../services/zone-setup.service'
...
export {
    ...
    deleteZoneSetupsParamValidation,updateZoneSetupValidation
}