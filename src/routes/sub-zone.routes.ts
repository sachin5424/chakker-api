...
import ZoneSetupController from '../controllers/sub-zone.controller';
import {addZoneSetupValidation,deleteZoneSetupsParamValidation,updateZoneSetupValidation} from '../validations/sub-zone-validations';
