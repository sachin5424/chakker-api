import DeviceSetUpController from './device-setup.controller';
import {deviceSetpValidation,upDateDeviceSetpValidation,powerDeviceSetpValidation} from './_Validations';
