...
const device_setup_dashboard_service_1 = require("./device-setup-dashboard.service");
...
const deviceSetpValidation = [
    ...
    (0, express_validator_1.check)("imeiNumber").notEmpty().withMessage(ValidationMessage.requiredField).isNumeric().isLength({ min: 16, max: 16 }),
    (0, express_validator_1.check)("operatorNumber").notEmpty().withMessage(ValidationMessage.requiredField).isNumeric().isLength({ min: 3 }),
    (0, express_validator_1.check)("simNumber").notEmpty().withMessage(ValidationMessage.requiredField).isString().isLength({ min: 3 }).withMessage(ValidationMessage.stringLength),
    (0, express_validator_1.check)("PumpHp").notEmpty().withMessage(ValidationMessage.requiredField).isString().isLength({ min: 3 }).withMessage(ValidationMessage.stringLength),
    (0, express_validator_1.check)("operatorName").notEmpty().withMessage(ValidationMessage.requiredField).isString().isLength({ min: 3 }).withMessage(ValidationMessage.stringLength),
    ...
    (0, express_validator_1.check)("place").notEmpty().withMessage(ValidationMessage.requiredField).isString().isLength({ min: 3 }).withMessage(ValidationMessage.stringLength),
...
const upDateDeviceSetpValidation = [
    ...
    (0, express_validator_1.check)("imeiNumber").optional().notEmpty().withMessage(ValidationMessage.requiredField).isNumeric().isLength({ min: 16, max: 16 }),
    (0, express_validator_1.check)("operatorNumber").optional().notEmpty().withMessage(ValidationMessage.requiredField).isNumeric().isLength({ min: 3 }),
    (0, express_validator_1.check)("simNumber").optional().notEmpty().withMessage(ValidationMessage.requiredField).isString().isLength({ min: 3 }).withMessage(ValidationMessage.stringLength),
    (0, express_validator_1.check)("PumpHp").optional().notEmpty().withMessage(ValidationMessage.requiredField).isString().isLength({ min: 3 }).withMessage(ValidationMessage.stringLength),
    (0, express_validator_1.check)("operatorName").optional().notEmpty().withMessage(ValidationMessage.requiredField).isString().isLength({ min: 3 }).withMessage(ValidationMessage.stringLength),
    ...
    (0, express_validator_1.check)("place").optional().notEmpty().withMessage(ValidationMessage.requiredField).isString().isLength({ min: 3 }).withMessage(ValidationMessage.stringLength),
    (0, express_validator_1.check)("latitude").optional().isFloat().withMessage(ValidationMessage.requiredField),
    (0, express_validator_1.check)("longitude").optional().isFloat().withMessage(ValidationMessage.requiredField)
];
...
//# sourceMappingURL=_Validations.js.map