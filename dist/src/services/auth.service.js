...
exports.userFindOne = exports.findDataByEmail = exports.genrateJwttoken = exports.emailcheckService = exports.adminLoginService = exports.userRegister = void 0;
...
let userFindOne = (value) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const fatchData = yield index_1.userModel.findOne(value).catch((error) => {
                reject(error);
            });
            resolve(fatchData);
        }
